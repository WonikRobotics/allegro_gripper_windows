...
#define ID_CMD_SET_POSE                 0xE0
#define ID_CMD_SET_POSE_1               (ID_CMD_SET_POSE+0)
#define ID_CMD_SET_POSE_2               (ID_CMD_SET_POSE+1)
#define ID_CMD_SET_POSE_3               (ID_CMD_SET_POSE+2)
#define ID_CMD_SET_POSE_4               (ID_CMD_SET_POSE+3)
#define ID_CMD_SET_PERIOD               0x81
#define ID_CMD_CONFIG                   0x68
#define ID_CMD_SET_MOTION				0x70
